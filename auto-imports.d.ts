...
declare global {
  const axiosReq: typeof import('@vue3-vite/remote/src/utils/axiosReq')['axiosReq']
  ...
  const useCommon: typeof import('@vue3-vite/remote/src/hooks/global/useCommon')['useCommon']
  const useCssModule: typeof import('vue')['useCssModule']
  const useCssVars: typeof import('vue')['useCssVars']
  const useElement: typeof import('@vue3-vite/remote/src/hooks/global/useElement')['useElement']
  const useRoute: typeof import('vue-router')['useRoute']
  const useRouter: typeof import('vue-router')['useRouter']
  const useSlots: typeof import('vue')['useSlots']
  const useStore: typeof import('vuex')['useStore']
  const useVueRouter: typeof import('@vue3-vite/remote/src/hooks/global/useVueRouter')['useVueRouter']
